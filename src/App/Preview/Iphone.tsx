...
import type { Model as ModelStyle } from './constants'
...
function Model(
  ...
  const texture = useTexture(props.style.img)
  ...
  useEffect(() => {
    Object.entries(materials).map((material) => {
      ...
      if (
        ...
        material[1].color = new THREE.Color(props.style.color[0])
      }
      material[1].needsUpdate = true
    })
  }, [materials, props.style])
